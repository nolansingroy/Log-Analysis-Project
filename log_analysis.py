...
def pop_3_articles_print():
    ...
    print '----------------------'
    query1 = """
        select popular_3_articles.title , popular_3_articles.views as views
        from popular_3_articles order by popular_3_articles.views desc limit 3;
        """
...
def pop_authors_print():
    ...
    print '----------------------'
    query2 = """
        select pop_authors_named.name,pop_authors_named.requested_views
        as views from pop_authors_named order by views desc;
        """
